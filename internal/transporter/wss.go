...
// var _ RelayTransporter = &WSSClient{}
...
// func (s *WSSClient) TCPHandShake(remote *lb.Node) (net.Conn, error) {
// 	t1 := time.Now()
...
// func (s *WSSClient) RelayTCPConn(c net.Conn, remote *lb.Node) error {
// 	clonedRemote := remote.Clone()
// 	wssc, err := s.TCPHandShake(clonedRemote)
// 	if err != nil {
// 		return err
// 	}
// 	s.l.Infof("RelayTCPConn from %s to %s", c.RemoteAddr(), remote.Address)
