...
// var _ RelayTransporter = &MTCPClient{}
...
// func (s *MTCPClient) RelayTCPConn(c net.Conn, remote *lb.Node) error {
// 	clonedRemote := remote.Clone()
// 	mtcpc, err := s.TCPHandShake(clonedRemote)
// 	if err != nil {
// 		return err
// 	}
...
// 			if err := s.raw.RelayTCPConn(c, remote); err != nil {
// 				s.l.Errorf("RelayTCPConn meet error from:%s to:%s err:%s", c.RemoteAddr(), remote.Address, err)
// 			}
// 		}(conn)
// 	}
// }
